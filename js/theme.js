...
export const theme = (() => {
  ...
  const onLight = () => {
    const elements = document.querySelectorAll(
      ".text-light, .btn-theme-light, .bg-dark, .bg-black, .bg-theme-dark, .color-theme-black, .btn-outline-light"
    );
  ...
  const onDark = () => {
    const elements = document.querySelectorAll(
      ".text-dark, .btn-theme-dark, .bg-light, .bg-white, .bg-theme-light, .color-theme-white, .btn-outline-dark"
    );
    elements.forEach((element) => {
